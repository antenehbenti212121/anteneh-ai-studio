...
(()=>{
  ...
  const load=()=>{if(window.__stageWorkspaceLoaded)return;window.__stageWorkspaceLoaded=true;const s=document.createElement('script');s.src='/stage-workspace.js';document.head.appendChild(s);const d=document.createElement('script');d.src='/research-decision-record.js';d.onload=()=>window.ResearchDecisionRecord?.render?.();document.head.appendChild(d);const m=document.createElement('script');m.src='/multilingual-collection.js';m.onload=()=>window.MultilingualCollection?.render?.(Number(JSON.parse(localStorage.getItem('arlab')||'{}').current||0));document.head.appendChild(m);const q=document.createElement('script');q.src='/questionnaire-builder.js';q.onload=()=>window.QuestionnaireBuilder?.render?.(Number(JSON.parse(localStorage.getItem('arlab')||'{}').current||0));document.head.appendChild(q);const x=document.createElement('script');x.src='/xlsform-exporter.js';x.onload=()=>window.XLSFormExporter?.render?.(Number(JSON.parse(localStorage.getItem('arlab')||'{}').current||0));document.head.appendChild(x);const c=document.createElement('script');c.src='/data-collection-stage.js';c.onload=()=>window.DataCollectionStage?.render?.(Number(JSON.parse(localStorage.getItem('arlab')||'{}').current||0));document.head.appendChild(c);const ql=document.createElement('script');ql.src='/data-quality-runtime.js';ql.onload=()=>window.DataQualityRuntime?.render?.(Number(JSON.parse(localStorage.getItem('arlab')||'{}').current||0));document.head.appendChild(ql);const ar=document.createElement('script');ar.src='/analysis-readiness.js';ar.onload=()=>window.AnalysisReadiness?.render?.(Number(JSON.parse(localStorage.getItem('arlab')||'{}').current||0));document.head.appendChild(ar)};
