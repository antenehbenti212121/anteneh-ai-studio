...
(()=>{
 ...
 async function boot(){
  ...
  ready=(async()=>{const mod=await import('https://webr.r-wasm.org/latest/webr.mjs');webR=new mod.WebR({channelType:mod.ChannelType.PostMessage,interactive:false});await webR.init();return webR})().catch(e=>{ready=null;throw e});
  return ready;
 }
